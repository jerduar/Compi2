...
public:
    ...
    void setupUi(QMainWindow *Ventana_Principal)
    {
        ...
        bt_buscar_3 = new QPushButton(centralWidget);
        bt_buscar_3->setObjectName(QStringLiteral("bt_buscar_3"));
        bt_buscar_3->setGeometry(QRect(890, 50, 161, 31));
    ...
    void retranslateUi(QMainWindow *Ventana_Principal)
    {
        ...
        bt_buscar_3->setText(QApplication::translate("Ventana_Principal", "COMPILAR JSLT", 0));
